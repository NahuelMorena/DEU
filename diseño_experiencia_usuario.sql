...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2023 a las 17:56:35
...
INSERT INTO `califications` (`id`, `note`, `id_user`, `id_training`, `id_trainer_planification`) VALUES
(36, 10, 24, 28, 50),
(37, 10, 24, 31, 51);
...
INSERT INTO `planifications` (`id`, `name`, `id_user`) VALUES
(32, 'asd', 7),
(34, 'Lunes', 22),
(35, 'miercoles', 22);
...
(25, 'Correr ', '2023-08-02', 17, 1, 'Deben correr mucho', 7, 1),
(26, 'Abdominales ', '2023-08-02', 17, 4, 'Abs', 0, 15),
(27, 'Lagartijas', '2023-08-02', 17, 4, 'Lagartijas..', 0, 20),
(28, 'Abdominales', '2023-08-03', 22, 4, 'abs', 0, 20),
(29, 'correr', '2023-08-03', 22, 1, 'correr', 10, 5),
(30, 'reducido', '2023-08-03', 22, 3, 'Mini partidito de futbol', 5, 15),
(31, 'Tipicos ejercicios de futbol', '2023-08-03', 22, 2, 'toques de pelota, rodear los conos, etc', 0, 10);
...
(1, NULL, 'admin', '$2a$12$BngXzPDbcSen1b.TCNha6uszCLVTiGoXCfo35q34KyP7bk5MSA/Km', 'Josefina', 'Gonzalez', 'admin@gmail.com', '1991-08-13', 23424235, NULL),
...
(22, NULL, 'melanie', '$2a$10$4ZJpPMA8Uk0cz0lW51CA2u7.z0Rqn1Z4huFuHaKxOaeXny2o60Bxu', 'Melanie', 'Gonzalez', 'melanie@gmail.com', '2001-02-06', 234235, NULL),
(24, 22, 'luciano', '$2a$10$M0nXcb6cVBwoVHtyiVFdd.1b0X8X3T5U5p9aQmmrBk3a7gfKzsZaW', 'Luciano', 'Caporossi', 'luciano@gmail.com', '1990-07-16', 3242423, 2),
(25, 22, 'santi', '$2a$10$Yg2iL2AMW67Q12AhRWkj.ucMODjhgVKkSDXXXaPyauIj4dMrmCwNS', 'Santiago', 'Perez', 'Santiago@gmail.com', '2008-02-14', 5678348, 1),
(26, 22, 'Male', '$2a$10$nSfIOppFN6auxM8VfoNNieqbb1F37rxh2qPbIBzm0CS.uEyzf2ILu', 'Male', 'Saggese', 'Male@gmail.com', '2023-08-01', 543254, 1);
...
ALTER TABLE `planifications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_trainer_planificator` (`id_user`);
...
--
-- Filtros para la tabla `planifications`
--
ALTER TABLE `planifications`
  ADD CONSTRAINT `id_trainer_planificator` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
